package com.worldline.android.headyio.commons.database;
...
public class SQLiteDatabaseManager
{
	...
	public static final String RESPONSE_TABLE = "ResponseTable";
	...
	{
		String[] requestTableColumnNames = {SQLiteDatabaseManager.TIMESTAMP,SQLiteDatabaseManager.RESPONSE};
		String[] requestTableColumnDataTypes = {"Text", "Text"};
		createTable(SQLiteDatabaseManager.RESPONSE_TABLE, requestTableColumnNames, requestTableColumnDataTypes);
